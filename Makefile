...
#
all:
	$(COMPILER) src/lorem.cpp src/stringutils.cpp src/nl.cpp src/en.cpp src/es.cpp src/pt.cpp src/de.cpp src/fr.cpp src/it.cpp src/se.cpp  src/ru.cpp src/main.cpp $(CFLAGS) -o $(CLIPSUM_EXECUTABLE)
